...
-- add a product to table with name of 'chair', price of '44.00' and can_be_returned of 'false'.
INSERT INTO products (name, price, can_be_returned) VALUES
products_db-# ('chair', 44.00, false);

-- add a product to table with name of 'stool', price of '25.99' and can_be_returned of 'true'.
INSERT INTO products (name, price, can_be_returned) VALUES        
('stool', 25.99, true);

-- add a product to table with name of 'table', price of '124.00' and can_be_returned of false.
INSERT INTO products (name, price, can_be_returned) VALUES        
('table', 124.00, false);
